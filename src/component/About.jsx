        ...
        <div id='About' className="container position-absolute aboutSha py-5 shadow-lg  rounded-md">
            <div className="row justify-center align-items-center">
                <div className="col-lg-6  position-relative ">
                  ...
                  <img  src={myImg} className='img-fluid bg-[#FFFFFF] my-4  shadow-md rounded-lg' alt="images" />
                </div>
                ...
                <div className="col-lg-6">
                   ...
                   <button data-aos="zoom-in" data-aos-duration="1500" className='aboutBtn w-[132px] h-[48px] font-serif tracking-wide bg-[#A53DFF] rounded-sm transition-transform duration-300 ease-in-out hover:bg-[#8A2BE2] hover:scale-105 hover:text-white hover:shadow-lg'>
                        My Project
                         </button>
                   </a>
                   ...
                   <button data-aos="zoom-in" data-aos-duration="1500"  className=' d-flex justify-center align-items-center aboutBtn2 w-[190px] h-[48px] font-serif tracking-wide bg-[#ffffff] rounded-sm transition-transform duration-300 ease-in-out hover:bg-[#8A2BE2] hover:scale-105 hover:text-white hover:shadow-l'> <span className='mx-2'><BsDownload /> </span> Download CV</button></a>
